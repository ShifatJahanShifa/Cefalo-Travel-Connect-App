import { authenticate, authorize, authorizeAdmin, ExpressRequest } from '../../../src/middlewares/auth.middleware.ts';
...
describe('Auth Middleware', () => {
    ...
    describe('authenticate', () => {
        ...
        authenticate(req as ExpressRequest, res, next);
    ...
    describe('authorize', () => {
        it('should allow admin to set user role', () => {
            ...
            authorize(req as ExpressRequest, res, next);
    ...
    describe('authorizeAdmin', () => {
        it('should allow admin to proceed', () => {
            ...
            authorizeAdmin(req as ExpressRequest, res, next);
